 ...
 */
public class FileStreamMySourceTask extends SourceTask {
    private static final Logger log = LoggerFactory.getLogger(FileStreamMySourceTask.class);
    ...
    public String version() {
        return new FileStreamMySourceConnector().version();
    }

    @Override
    public void start(Map<String, String> props) {
        filename = props.get(FileStreamMySourceConnector.FILE_CONFIG);
        ...
        topic = props.get(FileStreamMySourceConnector.TOPIC_CONFIG);
        if (topic == null)
